...
public class CommonSandbox 
{
	/**
	 * Algorithm to find all common elements in 2 sorted lists of numbers.
	 * For example, 2,5,5,5 and 2,2,3,5,5,7 should give 2,5,5.
	...
	public static void main(String[] args) 
	{
		...
		CommonSandbox cbox = new CommonSandbox();
